...
# GPIO Pin Configuration (BCM numbering)
RELAY_EXHAUST_FAN = 27 # PIN 11 on the board
RELAY_INTAKE_FAN = 22 # PIN 12 on the board
RELAY_HUMIDIFIER = 17 # PIN 13 on the board
RELAY_LED_LIGHTS = 18 # PIN 15 on the board
